...
def create_objects(sender, instance, created, **kwargs):
    ...
    if created:
        Message.objects.create(sender=wildpanMainUser, receiver=instance, content='This is your inbox! Click me to view our conversation.')
        ...
        Comment.objects.create(post=post, author=wildpanMainUser, content='Here is your first comment!')
